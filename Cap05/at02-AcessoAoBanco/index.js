...
app.post('/cadastrar/pets', async (req, res)=>{
    //let {nome, especie, idadeAproximada, porteTamanho, corPredominante, corSecundaria} = req.body
    //let dados = [nome, especie, parseFloat(idadeAproximada), porteTamanho, corPredominante, corSecundaria]
    ...
    try {
       con.query(sql, dados, (erro, resp)=>{
            ...
            else resposta = {...resp, status:200, message: `Sucesso: ${dados.affectedRows} linha(s) alterada(s)`}
